  ...
  return (
    <div className="contact-container">
      <div>
        <h2>Contact Me</h2>
        <p>
          Feel free to reach out to me via email, phone, or with the following
          form!
        </p>
      </div>
      <div className="contact-info">
        ...
        <h3>
          School Email: <a href="mailto:RyseA@cwu.edu">RyseA@cwu.edu</a>
        </h3>
        <h3>
          Phone: <a href="tel:+15099923778">509-992-3778</a>
        </h3>
      </div>

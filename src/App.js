...
function App() {
  ...
  return (
    <div id="page-top">
      <nav
        className={`${isMenuOpen ? "menu-open" : ""} ${isScrolled ? "scrolled" : ""}`}
      >
        ...
        <ul className={isMenuOpen ? "mobile-menu" : ""}>
          <li>
            <a
              ...
              className={isLoaded && activeSection === "home" ? "active" : ""}
            >
              HOME
            </a>
          </li>
          <li>
            <a
              ...
              className={isLoaded && activeSection === "about" ? "active" : ""}
            >
              ABOUT
            </a>
          </li>
          <li>
            <a
              ...
              className={
                isLoaded && activeSection === "experience" ? "active" : ""
              }
            >
              EXPERIENCE
            </a>
          ...
          <li>
            <a
              ...
              className={isLoaded && activeSection === "skills" ? "active" : ""}
            >
              SKILLS
            </a>
          </li>
          <li>
            <a
              ...
              className={
                isLoaded && activeSection === "projects" ? "active" : ""
              }
            >
              PROJECTS
            </a>
          ...
          <li>
            <a
              ...
              className={
                isLoaded && activeSection === "contact" ? "active" : ""
              }
            >
              CONTACT
            </a>
          ...
          <li>
            <a href="Resume Alex Ryse 3.3.pdf" target="_blank">
